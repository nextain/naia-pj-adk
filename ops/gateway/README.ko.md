...
감사는 완료된 추적 항목도 대조합니다. GitHub와 추적표는 완료인데 Discord 스레드가
열려 있으면 종료 후속 확인 대상으로 보고하고 `exit 1`을 반환합니다. 이는 보관
실행 허가가 아닙니다. 실제 정리 담당은 최신 사람 요청, 진행 중인 작업과 최종 보고를
먼저 확인해야 합니다. 보고기는 입력 파일을 바꾸거나 작업을 재실행하지 않습니다.
